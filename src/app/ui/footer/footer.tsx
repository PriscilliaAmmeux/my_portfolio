  ...
  return (
    <footer className="bg-[#be185d] text-white w-full px-6 py-10 md:px-16 flex flex-col gap-10 mt-10">
      <section className="flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        <nav className="flex flex-col md:flex-row text-left gap-6 md:gap-20 text-lg ">
      ...
      <section className="border-t border-white/30 pt-6 text-center text-lg md:text-lg flex flex-col gap-4 items-center">
        ...
        <div className="flex flex-col gap-2 items-center">
          ...
          <p className="text-lg">Site développé & designé par Pixelia&Co</p>
        </div>
      </section>
    </footer>
  );

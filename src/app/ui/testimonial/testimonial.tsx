    ...
    <section className="mt-4 max-w-4xl mx-auto">
      <blockquote className="bg-pink-700 p-8 shadow-lg text-center">
        ...
        <p className="text-white text-lg leading-relaxed italic mb-6">
          ...
          rapport aux prestations proposées évoluent, il m'a suffi d'envoyer un
          message à Priscillia et nous retravaillons déjà dessus !
        </p>
        ...
        <footer className="border-t border-pink-500 pt-4">
          <cite className="not-italic">
            ...
            <span className="text-pink-200 text-sm">Praticienne bien-être</span>
          </cite>
        </footer>
      </blockquote>
    </section>

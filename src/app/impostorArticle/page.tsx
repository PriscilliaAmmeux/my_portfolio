      ...
      <ArticleHeader
        ...
        <SectionArticle
          ...
          content={
            <ul className="list-disc list-inside space-y-4">
              <li>
                <span className="font-bold pr-1">Un peu d’histoire :</span>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Cette croyance que si tu réussis, c’est un coup de chance ou
                    c’est grâce à Pierre, Paul, Jacques
                  </li>
                  <li>
                  ...
                  <li>
                    Ce doute est nourri par la peur !​ La peur constante de mal
                    faire et de ne pas être à la hauteur !​ La peur d’être
                    démasqué(e)
                  </li>
                </ul>
              </li>
        ...
        <SectionArticle
          ...
          content={
            <ul className="list-disc list-inside space-y-4">
              <li>
                <span className="font-bold pr-1">Faire des listes :</span>
              ...
              <li>
                <span className="font-bold pr-1">Partager et contribuer :</span>
        ...
        <SectionArticle
          ...
          content={
            <ul className="list-disc list-inside space-y-4">
              ...
              <li>
                <span className="font-bold pr-1">Oser : </span>aujourd’hui je
                fais partie du collectif KreaWebSolutions, un collectif de 5
